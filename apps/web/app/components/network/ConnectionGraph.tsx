    ...
    return (
      <div className="flex items-center justify-center h-96 bg-secondary rounded-lg border border-border">
        <div className="text-center text-muted-foreground">
          ...
          <p className="text-xs mt-2 text-muted-foreground/70">Check browser console for debug info</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div className="bg-card rounded-lg p-4 border border-border">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-1">Your Connection Network</h3>
      ...
      {/* Graph Container */}
      <div id="graph-container" className="bg-secondary rounded-lg border border-border overflow-hidden">
        <Suspense fallback={
          <div className="flex items-center justify-center h-96">
            <div className="text-center">
              <div className="w-8 h-8 border-2 border-primary border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
      ...
      {/* Details Panel */}
      {selectedNode && (
        <div className="bg-gradient-to-r from-blue-100/80 to-purple-100/80 dark:from-blue-900/50 dark:to-purple-900/50 rounded-lg p-6 border border-blue-200 dark:border-blue-700/50">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h4 className="text-xl font-bold text-foreground mb-1">{selectedNode.name}</h4>
              {selectedNode.email && (
                <p className="text-sm text-muted-foreground mb-3">{selectedNode.email}</p>
              )}
      ...
      {selectedLink && (
        <div className="bg-gradient-to-r from-yellow-100/80 to-orange-100/80 dark:from-yellow-900/50 dark:to-orange-900/50 rounded-lg p-6 border border-yellow-200 dark:border-yellow-700/50">
          <h4 className="text-xl font-bold text-foreground mb-3">Connection Details</h4>
