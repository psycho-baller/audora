    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      <div className="relative z-10 text-center max-w-7xl mx-auto">
        <div className="mb-8 animate-fade-in">
          <h1 className="text-6xl md:text-8xl 2xl:text-9xl font-bold mb-4 sm:mb-6 md:mb-8">
            Audora
          </h1>
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-semibold mb-6 md:mb-8">
            <span className="bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">
              The First Private AI Communication OS
            </span>
          </h2>
          <p className="text- md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
